...
const void print_difference(HashMap<string, int>& lecturer_record, string lecturer1, string lecturer2);
template<typename KeyType, typename MappedTyped>
std::set<KeyType> const find_keys(HashMap<KeyType, MappedTyped>& map);
...
const void print_difference(HashMap<string, int>& lecturer_record, const string lecturer1, const string lecturer2){
